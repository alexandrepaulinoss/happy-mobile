    ...
    <ScrollView style={styles.container}>
      ...
      <View style={styles.detailsContainer}>
        ...
        {orphanage.need_items && (
          <View style={[styles.scheduleItem, styles.scheduleItemRed]}>
            <Feather name="alert-circle" size={40} color="#FF669D" />
            <Text style={[styles.scheduleText, styles.scheduleTextRed]}>Itens de necessidade:</Text>
            <Text style={[styles.scheduleText, styles.scheduleTextRed]}>{orphanage.need_items}</Text>
          </View>
        )}
            ...
            Linking.canOpenURL("whatsapp://send?text=oi").then(supported => {
              if (supported) {
                return Linking.openURL(
                  `whatsapp://send?phone=55${orphanage.phone}&text=Oi`
                );
              } else {
                return Linking.openURL(
                  `https://api.whatsapp.com/send?phone=55${orphanage.phone}&text=Oi`
                );
              }
            })
          }}>
